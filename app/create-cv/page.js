                ...
                <div className="mt-4 bg-gray-900 border border-gray-800 rounded-2xl p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div className={`text-3xl font-bold ${scoreData.totalScore >= 80 ? 'text-green-400' : scoreData.totalScore >= 60 ? 'text-yellow-400' : 'text-red-400'}`}>
                        {scoreData.totalScore ?? scoreData.toplam_puan ?? '—'}
                      </div>
                    ...
                    {[
                      ...
                      <div key={label} className="bg-gray-800 rounded-xl p-3">
                        ...
                        <div className="w-full bg-gray-700 rounded-full h-1.5 mb-1">
                          <div className={`h-1.5 rounded-full ${val >= 20 ? 'bg-green-500' : val >= 13 ? 'bg-yellow-500' : 'bg-red-500'}`} style={{ width: `${(val / 25) * 100}%` }}></div>
                        </div>
                        <p className="text-white text-xs font-medium">{val}/25</p>
                      </div>
                    ))}
                  </div>
